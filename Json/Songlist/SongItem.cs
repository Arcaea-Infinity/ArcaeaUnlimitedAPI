...
public class SongItem
{
    ...
    [JsonProperty("artist")] public string Artist { get; set; } = string.Empty;

    [JsonProperty("bpm")] public string Bpm { get; set; } = string.Empty;

    [JsonProperty("bpm_base")] public double BpmBase { get; set; }

    [JsonProperty("set")] public string Set { get; set; } = string.Empty;
    ...
    [JsonProperty("bg")] public string Background { get; set; } = string.Empty;
