...
[Serializable]
[Table("players")]
[DatabaseManager.CreateTableSql("CREATE TABLE `players` (`uid`  INTEGER NOT NULL,`code` TEXT NOT NULL,`name` TEXT NOT NULL,`ptt`  INTEGER DEFAULT -1,`join_date` INTEGER NOT NULL,PRIMARY KEY (`uid` ASC));")]
