...
[Serializable]
[Table("players")]
[DatabaseManager.CreateTableSqlAttribute("CREATE TABLE IF NOT EXISTS `players` (`uid`  INTEGER NOT NULL,`code` TEXT NOT NULL,`name` TEXT NOT NULL,`ptt` INTEGER DEFAULT -1,`join_date` INTEGER NOT NULL,PRIMARY KEY (`uid` ASC));")]
public sealed class PlayerInfo
{
    ...
    internal static List<PlayerInfo> GetByCode(string code) => DatabaseManager.Player.Where<PlayerInfo>(i => i.Code == code).ToList();
